...
// Error boundary compartido para todas las páginas de reportes.
// Captura errores de servidor (Neon cold start, timeouts, errores de red)
// y muestra una UI de recuperación en lugar del error boundary global.
    ...
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="mx-auto max-w-md space-y-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-800">
          {isColdStart ? "La base de datos está iniciando" : "Error al cargar el reporte"}
        </h2>

        <p className="text-sm text-zinc-500">
          {isColdStart
            ? `Reconectando automáticamente en ${countdown}s…`
            : "Ocurrió un error al obtener los datos del reporte. Puedes reintentar o volver a la lista de reportes."}
        </p>
