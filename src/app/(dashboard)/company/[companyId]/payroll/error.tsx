...
export default function PayrollError({ error, reset }: Props) {
    ...
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="mx-auto max-w-md space-y-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-800">
          {isColdStart ? "La base de datos está iniciando" : "Error al cargar la nómina"}
        </h2>

        <p className="text-sm text-zinc-500">
          {isColdStart
            ? `Reconectando automáticamente en ${countdown}s…`
            : "Ocurrió un error al obtener los datos de nómina. Puedes reintentar o volver al módulo."}
        </p>
        ...
        <div className="flex justify-center gap-3 pt-2">
          ...
          {params?.companyId && (
            <Link
              href={`/company/${params.companyId}/payroll`}
