...
const PROFILES = [
  {
    ...
    priceAlt: "o $69/mes sin compromiso",
  ...
  },
  {
    ...
    price: "$65",
    pricePeriod: "/mes · plan anual",
    priceAlt: "o $79/mes sin compromiso",
  ...
  },
  {
    ...
    includes: [
      ...
      "Múltiples RIFs gestionados desde un panel",
      "Empresa propia incluida + RIFs de clientes",
      "Tiers Starter / Pro / Ilimitado según nº de RIFs",
    ],
    excluded: [],
    roiHours: "30+",
    price: "$119",
    pricePeriod: "/mes · 5 RIFs",
    priceAlt: "Pro $249 (25 RIFs) · Ilimitado $359 — escala con tus clientes",
