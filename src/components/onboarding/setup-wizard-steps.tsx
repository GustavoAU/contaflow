...
// src/components/onboarding/setup-wizard-steps.tsx
// Presentacional — extraído MECÁNICAMENTE desde SetupWizard.tsx (sin cambios) — split por tamaño de archivo.
// Componentes de paso + guías de migración usados por el contenedor SetupWizard.
...
export type WizardPath = "scratch" | "migrate";
export type MigrationSystem = "excel" | "monica" | "odoo";
...
export function ScratchStepBar({ current }: { current: number }) {
  return (
