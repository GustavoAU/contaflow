              ...
              >
                <Link href={`/company/${company.id}`} className="block p-5 pb-14">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <span className={`rounded-full px-2 py-0.5 text-[11px] font-semibold ${ROLE_BADGE[role]}`}>
                      {ROLE_LABELS[role]}
                    </span>
                    ...
                    {period ? (
                      ...
                      <span className="text-[11px] text-zinc-400">Sin período</span>
                    )}
                  </div>
                </Link>
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-center gap-1 rounded-b-xl border-t border-zinc-100 bg-white px-5 py-2.5 opacity-0 transition-opacity group-hover:pointer-events-auto group-hover:opacity-100">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-1.5 rounded-md px-3 py-1.5 text-[12px] font-medium text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800"
                  >
